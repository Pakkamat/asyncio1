...
async def main():
    ...
    # create a coroutine or the blocking task
...
# run the asyncio progra
asyncio.run(main())

# Wed Jul 19 13:42:39 2023 Main running the blocking task
# Wed Jul 19 13:42:39 2023 Main doing other things
# Wed Jul 19 13:42:39 2023 Task starting...
# Wed Jul 19 13:42:41 2023 Task done